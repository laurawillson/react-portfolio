    ...
    return(
        ...
        <div className={`fixed px-6 sm:px-8 w-full bg-zinc-800 z-10 ${isMobileNavOpen ? "translate-y-20" : "-translate-y-80"}  md:hidden `} id="mobile-menu">
                <div className="py-1" role="none">
                    <Link 
                        onClick={updateNavActive}
                        to="/react-portfolio" className="text-white block px-4 py-2 text-sm" role="menuitem" tabIndex="-1" id="menu-item-2">All Projects</Link>
                    <Link 
                        onClick={updateNavActive}
                        to="/react-portfolio/Schedulete" className="text-white block px-4 py-2 text-sm" role="menuitem" tabIndex="-1" id="menu-item-1">Schedulete</Link>
                    <Link 
                        onClick={updateNavActive}
                        to="/react-portfolio/Kikori" className="text-white block px-4 py-2 text-sm" role="menuitem" tabIndex="-1" id="menu-item-0">Kikori</Link>
                    <Link 
                        onClick={updateNavActive}
                        to="/react-portfolio/Paella_Bowls" className="text-white block px-4 py-2 text-sm" role="menuitem" tabIndex="-1" id="menu-item-1">Paella Bowls</Link>
                {
                    navItems2.map((items,index)=>{
                        <li key={index}>
                            <Link 
